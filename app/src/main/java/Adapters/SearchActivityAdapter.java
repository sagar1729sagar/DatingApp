...
public class SearchActivityAdapter extends RecyclerView.Adapter<SearchActivityAdapter.MyViewHolder> {
    ...
    private List<SearchedActivities> activities;
    private Prefs prefs;
    ...
    public SearchActivityAdapter(Context context, List<SearchedActivities> activities) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.searched_activity_row,parent,false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final SearchedActivities activity =  activities.get(position);
        ...
        if (SavedActivities.find(SavedActivities.class,"objectId = ?",activity.getObjectId()).size() > 0){
        ...
        private void contactPerson(final SearchedActivities activity) {
        ...
        private void checkPushNotificationRegistration(final SearchedActivities activity) {
        ...
        private void registerDevice(final SearchedActivities activity) {
