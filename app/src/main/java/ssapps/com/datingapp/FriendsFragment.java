...
import ssapps.com.datingapp.databinding.ActivityFriendsFragmentBinding;

public class FriendsFragment extends Fragment{

   private ActivityFriendsFragmentBinding binding;
   private SweetAlertDialog dialog,error;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater,R.layout.activity_friends_fragment,container,false);
    ...
    private void getList() {
        ...
        mDatabase.child(prefs.getname()).child("Friends").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
