...
public class FavouritesList extends Fragment {
    ...
    private ArrayList<String> allFavourites = new ArrayList<>();
    ...
    private void getList() {
        ...
        mDatabase.child(prefs.getname()).child("Favourites").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                favourites.clear();
                favourites.addAll(set);
                allFavourites.clear();
                allFavourites.addAll(set);
...
//            }
        Log.v("friends size", String.valueOf(allFavourites.size()));
        List<User> users = new ArrayList<>();
        for (String friend:allFavourites){
            Log.v("friend",friend);
